-- FUNCTION: public.vs_reversegeocode(double precision, double precision, boolean, character)

-- DROP FUNCTION public.vs_reversegeocode(double precision, double precision, boolean, character);

CREATE OR REPLACE FUNCTION public.vs_reversegeocode(
...
ALTER FUNCTION public.vs_reversegeocode(double precision, double precision, boolean, character)
    OWNER TO postgres;
