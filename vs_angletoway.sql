-- FUNCTION: public.vs_angletoway(geometry, geometry[])

-- DROP FUNCTION public.vs_angletoway(geometry, geometry[]);
...
begin
	...
	foreach Street in array Way loop
		...
		--if vs_TouchWay(line,Array[Street]) then		
			...
			raise debug 'AngleOffset=%',AngleOffset;
...
ALTER FUNCTION public.vs_angletoway(geometry, geometry[])
    OWNER TO postgres;
